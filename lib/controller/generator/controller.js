...
Controller.prototype.registerRoute = function (verb, uri, handler, mware_) {
    var method = verb.toLowerCase(),
        mware = mware_;
    if (mware) {
        mware = util.isArray(mware) ? mware : [mware];
        this.app.all.apply(this.app, mware)[method](uri, handler.bind(this));
    } else {
